...
#define STR_INVALID_COLOR_VALUE "Invalid color value (%u) for key \"%s\""
#define STR_SUS_LARGE_VALUE "Suspiciously large value (%u) for key \"%s\""
...
#define STR_START_ROOM_INVALID "Error loading location (%s) - start room coordinates invalid: (%u, %u)."
#define STR_ROOM_DUPLICATE "Error loading location (%s) - duplicate room definition: \"%s\"."
...
#define STR_LOADING_LOCATION_ERROR "Loading location failed (%s)."
