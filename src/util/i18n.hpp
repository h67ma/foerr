...
#define STR_INVALID_VALUE_COLOR "Invalid color value for %s: \"%s\" - using default value. Value should be formatted as #RRGGBB."
...
#define STR_NO_ROOMS_DEFINED "Error loading location (%s) - no rooms defined."
