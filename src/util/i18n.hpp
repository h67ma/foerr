...
#define STR_CURSOR_SET_FAIL "Error setting cursor."
...
#define STR_SETTINGS_KEY_MISSING "Key is missing from settings file: \"%s\" - using default value (%s)."
...
#define STR_INVALID_VALUE_HINT_U "Invalid value for %s: \"%u\" - using default value. Value should be %s."
#define STR_INVALID_VALUE_HINT_F "Invalid value for %s: \"%g\" - using default value. Value should be %s."
...
#define STR_LOADED_SETTING_F "Loaded setting: %s = %g"
...
#define STR_PIPBUCK_CLOSE "Close"
...
#define STR_BACK_OBJ_DEF_NOT_FOUND "Back object definition not found (%s)"
